...
function _attachMessageHandler(conn, subbotId, db) {
    conn.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        // ✅ Usar el banner del subbot si tiene, si no el banner original del bot principal
        // Nunca mezclar banners entre subbot y bot principal
        global.banner = subbotData?.banner && subbotData.banner !== originalBanner
            ? subbotData.banner
            : originalBanner
