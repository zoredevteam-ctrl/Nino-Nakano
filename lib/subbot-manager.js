...
// Map por conn para saber qué subbotId le corresponde
...
function _attachMessageHandler(conn, subbotId, db) {
    conn.ev.on('messages.upsert', async ({ messages, type }) => {
        ...
        // ✅ Setear contexto del subbot activo
        ...
        try {
            ...
            // ✅ Restaurar siempre el contexto del bot principal
    ...
    conn.ev.on('group-participants.update', async (anu) => {
        try {
            ...
            // ✅ Resolver el banner correcto para este subbot
            // Prioridad: banner propio del subbot → banner global del bot principal
            const activeBanner = subbotData?.banner || global.banner || ''
            ...
            for (const num of anu.participants) {
                ...
                try {
                    ...
                    // ✅ Si no hay foto de perfil, usar el banner del subbot
                    ppuser = activeBanner
                }
                    ...
                    await conn.sendMessage(anu.id, {
                        ...
                        contextInfo: {
                            ...
                            externalAdReply: {
                                ...
                                // ✅ Banner del subbot en el thumbnail
                                thumbnailUrl: activeBanner,
                                sourceUrl: canalLink,
                                mediaType: 1,
